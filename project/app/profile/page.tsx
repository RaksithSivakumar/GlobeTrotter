...
import { Edit, Save, X, User, Mail, MapPin, Globe, FileText, Calendar, Star } from 'lucide-react';
                  ...
                  {isEditing ? (
                    <>
                      ...
                      <p className="text-xs text-gray-500">
                        Enter a publicly accessible image URL. The avatar will update automatically.
                      </p>
                    </>
                  ) : (
